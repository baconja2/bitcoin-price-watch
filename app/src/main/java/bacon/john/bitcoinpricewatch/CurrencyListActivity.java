 ...
 * {@link CurrencyListFragment} and the item details
 * (if present) is a {@link CurrencyDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link CurrencyListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class CurrencyListActivity extends FragmentActivity
        implements CurrencyListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.currency_detail_container) != null) {
            ...
            ((CurrencyListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.currency_list))
    ...
    /**
     * Callback method from {@link CurrencyListFragment.Callbacks}
